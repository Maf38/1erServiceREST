...
import sandbox.Affectation;
import sandbox.AffectationPK;
...
public class AffectationFacadeREST extends AbstractFacade<Affectation> {
    ...
    private AffectationPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        sandbox.AffectationPK key = new sandbox.AffectationPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        sandbox.AffectationPK key = getPrimaryKey(id);
